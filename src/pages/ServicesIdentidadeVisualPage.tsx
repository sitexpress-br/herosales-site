...
import { Crown, Palette, TextT, IdentificationCard, FileText, Envelope, Folder, InstagramLogo, SquaresFour, Book, CloudArrowDown, Image, MagnifyingGlass, Lightbulb, PencilLine, CheckCircle, Package, Trophy, Target, ArrowRight, Clock, WhatsappLogo, Eye, Star, Handshake } from "@phosphor-icons/react";
...
import identidadeVisualHero from "@/assets/identidade-visual-hero.avif";

// Galeria de logotipos criados
const logoGallery = [
  { name: "Silva & Associados", logo: "/placeholder.svg" },
  { name: "Clínica Martins", logo: "/placeholder.svg" },
  { name: "Costa Medical", logo: "/placeholder.svg" },
  { name: "Clínica Pereira", logo: "/placeholder.svg" },
  { name: "Mendes & Associados", logo: "/placeholder.svg" },
  { name: "Clínica Lima", logo: "/placeholder.svg" },
  { name: "Clínica Souza", logo: "/placeholder.svg" },
  { name: "Clínica Ferreira", logo: "/placeholder.svg" },
];

// Vantagens de Identidade Visual
const identidadeVisualAdvantages = [{
  icon: Eye,
  title: "Primeira Impressão Impactante",
  description: "Clientes confiam antes mesmo de conhecê-lo"
}, {
  icon: Star,
  title: "Diferenciação no Mercado",
  description: "Destaque-se da concorrência genérica"
}, {
  icon: Handshake,
  title: "Consistência Visual",
  description: "Mesma qualidade em todos os materiais"
}, {
  icon: Trophy,
  title: "Profissionalismo Percebido",
  description: "Posicionamento premium desde o cartão"
}];

// Recursos técnicos para Identidade Visual
const allFeatures = [{
  icon: Crown,
  title: "Logo Principal",
  description: "Símbolo único da sua marca"
}, {
  icon: Image,
  title: "Versões da Logo",
  description: "Horizontal, vertical e ícone"
}, {
  icon: Palette,
  title: "Paleta de Cores",
  description: "Cores que comunicam autoridade"
}, {
  icon: TextT,
  title: "Tipografia Profissional",
  description: "Fontes que transmitem credibilidade"
}, {
  icon: IdentificationCard,
  title: "Cartão de Visita",
  description: "Design premium para networking"
}, {
  icon: FileText,
  title: "Papel Timbrado",
  description: "Documentos com identidade"
}, {
  icon: Envelope,
  ...
  description: "Materiais físicos elegantes"
}, {
  icon: InstagramLogo,
  title: "Capa para Redes Sociais",
  description: "Presença digital consistente em todos os canais"
}, {
  icon: SquaresFour,
  title: "Templates para Posts",
  description: "Modelos prontos integrados ao Hero Sales"
}, {
  icon: Book,
  title: "Manual de Marca",
  description: "Guia completo para aplicação consistente"
}, {
  icon: CloudArrowDown,
  title: "Arquivos Editáveis",
  description: "Todos os formatos prontos na plataforma"
}];
...
const processSteps = [{
  icon: Lightbulb,
  title: "Briefing",
  description: "Entendemos sua área e posicionamento"
}, {
  icon: MagnifyingGlass,
  title: "Pesquisa",
  description: "Analisamos concorrência e referências"
}, {
  icon: PencilLine,
  title: "Criação",
  description: "Desenvolvemos conceitos de logo"
}, {
  icon: CheckCircle,
  title: "Refinamento",
  description: "Ajustamos até a aprovação final"
}];
const supportStep = {
  icon: Package,
  title: "Entrega",
  description: "Disponibilizamos todos os materiais"
};
...
const ServicesIdentidadeVisualPage = () => {
  ...
  return <div className="min-h-screen bg-background">
      <SEOHead
        title={PAGE_SEO.services.identidadeVisual.title}
        description={PAGE_SEO.services.identidadeVisual.description}
        canonical={`${SEO_CONFIG.siteUrl}/servicos/identidade-visual`}
        ogType="website"
      />
      <ServiceSchema
        name="Identidade Visual para Clínicas — Hero Sales"
        description={PAGE_SEO.services.identidadeVisual.description}
        url={`${SEO_CONFIG.siteUrl}/servicos/identidade-visual`}
      />
      <BreadcrumbSchema
        items={[
          { name: "Home", url: SEO_CONFIG.siteUrl },
          { name: "Serviços", url: `${SEO_CONFIG.siteUrl}/servicos` },
          { name: "Identidade Visual", url: `${SEO_CONFIG.siteUrl}/servicos/identidade-visual` },
        ]}
      />
      <Header />

      {/* Hero Section */}
      <section className="relative min-h-[60vh] lg:min-h-[80vh] bg-secondary overflow-x-clip">
        {/* Subtle radial gradient for depth */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_hsl(var(--primary)/0.15)_0%,_transparent_50%)]" />
        
        {/* Gradient fade from left to right - text emphasis */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,hsl(var(--secondary))_0%,hsl(var(--secondary))_40%,hsl(var(--secondary)/0.9)_50%,transparent_60%)] z-[5]" />

        {/* Content Container */}
        <div className="relative z-10 container mx-auto px-6 pt-32 pb-10 lg:pt-32 lg:pb-16 min-h-[60vh] lg:min-h-[80vh] flex flex-col justify-center">
          
          {/* Text Content */}
          <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative text-left max-w-2xl">
            {/* Badge */}
            <motion.div variants={badgeVariants} className="mb-6">
              <Badge variant="gold" className="text-sm px-4 py-2">
                Branding Profissional incluso no Hero Sales
              </Badge>
            </motion.div>
            ...
            <motion.h1 variants={fadeInUp} className="font-display text-4xl md:text-5xl lg:text-5xl xl:text-6xl text-white leading-tight mb-6">
              ...
              <em className="text-primary italic">Autoridade e Confiança</em>
            </motion.h1>

            {/* Subheadline */}
            <motion.p variants={fadeInUp} className="text-lg md:text-xl text-white/70 mb-10 max-w-xl leading-relaxed">
              Logo, materiais gráficos e templates prontos para usar — tudo integrado à plataforma Hero Sales para manter sua marca consistente em cada ponto de contato.
            </motion.p>
            ...
            <motion.div variants={fadeInUp}>
              ...
              scale: 0.98
                ...
                <Button variant="gold" size="lg" onClick={handleWhatsAppClick} className="group shadow-gold w-full sm:w-auto text-sm sm:text-base">
                  ...
                  <span className="truncate">Começar com Hero Sales</span>
          ...
          {/* Hero Image - Absolute positioned at bottom right with overflow */}
          <motion.div 
            initial={{ opacity: 0, x: 40 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: 0.3 }}
            className="hidden lg:block absolute bottom-0 left-1/2 -translate-x-1/2"
          >
            <img 
              src={identidadeVisualHero} 
              alt="Identidade Visual para Clínicas" 
              className="w-[1400px] max-w-none object-contain drop-shadow-2xl ml-[-200px]"
            />
          </motion.div>
        </div>
      </section>

      {/* Vantagens de Identidade Visual - Estilo Results.tsx */}
        ...
        <div className="container mx-auto px-6">
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={defaultViewport} className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-4xl lg:text-5xl text-secondary mb-4">
              Por que investir em{" "}
              <em className="text-primary italic">Identidade Visual?</em>
            </h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Uma marca forte faz pacientes confiarem antes mesmo de conhecê-lo
            </p>
          </motion.div>
          ...
          {identidadeVisualAdvantages.map((advantage, index) => <motion.div key={index} variants={staggerItem} whileHover={{
            y: -4
          }} transition={{
            duration: 0.3
      ...
      <section id="logotipos" className="bg-secondary py-10 md:py-[90px]">
        <div className="container mx-auto px-6">
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={defaultViewport}>
            <motion.div variants={fadeInUp} className="text-center mb-16">
              <h2 className="font-display text-3xl md:text-4xl lg:text-5xl mb-4 text-white">
                Marcas Criadas com <em className="text-primary italic">Hero Sales</em>
              </h2>
              <p className="text-white/60 text-lg max-w-2xl mx-auto">
                Identidades visuais de clínicas que usam a plataforma
              </p>
            </motion.div>
              ...
              {logoGallery.map((item, index) => (
                <motion.div key={index} variants={staggerItem}>
                  <motion.div
                    ...
                    className="bg-white rounded-xl p-8 flex items-center justify-center aspect-square shadow-lg hover:shadow-gold transition-shadow duration-300"
                  >
                    <img 
                      src={item.logo} 
                      alt={`Logo ${item.name}`} 
      ...
      {/* O Que Sua Identidade Visual Terá - Grid Assimétrico */}
      <section className="bg-background py-10 md:py-[90px]">
        <div className="container mx-auto px-6">
          <motion.div variants={fadeInUp} initial="hidden" whileInView="visible" viewport={defaultViewport} className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Tudo que você precisa para uma marca profissional
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 relative z-10">
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={defaultViewport} className="max-w-3xl mx-auto text-center">
            <motion.h2 variants={fadeInUp} className="font-display text-3xl md:text-4xl lg:text-5xl font-normal text-secondary mb-4">
              Pronto para ter uma{" "}
              <em className="text-primary italic">marca profissional</em>?
            </motion.h2>

            <motion.p variants={fadeInUp} className="text-muted-foreground text-lg mb-8">
              Sua marca profissional, integrada a toda a plataforma Hero Sales
            </motion.p>
...
export default ServicesIdentidadeVisualPage;
